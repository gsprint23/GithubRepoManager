...
if __name__ == "__main__":
    ...
    organization_name = "GonzagaCPSC312" 
    ...
    for repo in g.get_organization(organization_name).get_repos(type="public", sort="full_name"): # NOTE: can set type="private"
        ...
        if ("Fun" in repo.name or "Exam" in repo.name) and not repo.name.startswith("F17") and not repo.name.startswith("F19"):
